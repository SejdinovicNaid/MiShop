...
function SmartDevices() {
  return (
   ...
   <div className=" "><Link to="/smart">Smart Device <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeEp71HheSyezxCMybJhMM94gj6Y0OUN1uqA" className=" h-16 w-16 mt-2 rounded-full ml-7 hover:scale-110 shadow-lg shadow-[#FF681F] scale-110" /></Link> </div> 
